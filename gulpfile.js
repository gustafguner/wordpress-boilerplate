...
gulp.task("js:prod", function() {
  return gulp
    .src(["node_modules/jquery/dist/jquery.js", "src/js/**/*.js"], {
      base: "./"
    })
...
gulp.task("clean", function() {
  return gulp.src("dist", { base: "./" }).pipe(clean());
});
...
gulp.task("jquery", function() {
  return gulp
    .src("node_modules/jquery/dist/jquery.js", { base: "./src" })
    .pipe(sourcemaps.init())
...
gulp.task("watch", ["jquery"], function() {
  ...
  gulp
    .watch(["./src/css/sass/**/*.scss", "./src/js/**/*.js", "./src/**/*.php"])
...
gulp.task("prod-config", function() {
  gulp
    .src("./src/prod_config/**/*.php", { base: "./src/prod_config" })
